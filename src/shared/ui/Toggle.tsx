...
export default function Toggle({
  ...
  return (
    <label className="flex items-center gap-[16px] pl-[35px] text-[11px] text-black">
      ...
      />
      <span className="relative h-[20px] w-[34px] shrink-0 rounded-full bg-[#c8c8c8] transition-colors peer-checked:bg-stat-blue peer-checked:[&>span]:translate-x-[14px] peer-focus-visible:ring-2 peer-focus-visible:ring-stat-blue/50 peer-disabled:opacity-50">
