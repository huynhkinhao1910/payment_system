...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-[16px] py-[120px] text-center">
      <p className="text-[64px] font-medium leading-none text-[#3191ff]">404</p>
      <h1 className="text-[14px] font-medium text-[#353535]">Page not found</h1>
      <p className="text-[11px] text-[#6c6c6c]">The page you're looking for doesn't exist or has moved.</p>
